...
COINGECKO_CACHE_FILE_NAME = "coingecko"
...
EXCHANGERATE_CACHE_FILE_NAME = "exchangerate"
...
LOGO_DIR = Path().cwd().joinpath('media').joinpath('crypto_images')
LOGOS_EXTENSION = 'png'

# --- Cache ---
CACHE_DIR = Path().cwd().joinpath('cache')

STATE_DIR = CACHE_DIR # Temporary
STATE_FILE_NAME = "state"

# Формат сохранения даты кэширования
DATETIME_FORMAT = "%Y-%m-%d %H:%M:%S"

# Время (мин), по истечении которого данные в файле считаются устаревшими
COINGECKO_TIME_TO_LIVE = 60

EXCHANGERATE_TIME_TO_LIVE = 10080
