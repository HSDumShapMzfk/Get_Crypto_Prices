...
class CacheError(Enum):
	FILE_NOT_EXIST = auto()
	LIVE_TIME_EXPIRED = auto()
...
class JSONCacheHandler:
	...
	CACHE_DIR = WD_PATH / "cache"
	DATETIME_FORMAT = load.config["cache"].get("datetime_format")

	def __init__(self, file_name: str, time_to_live: int):
		self.cache_file_name = cache_file_name
		self.cache_file_path = self.CACHE_DIR / self.cache_file_name
